    ...
    <div className="flex h-full w-full flex-col gap-2">
      ...
      <div className="w-fit h-[400px] px-8 py-4 rounded-lg border border-gray">
        <div className="w-full flex flex-row justify-between items-center mb-4">
          ...
          <div className="flex flex-row gap-2 text-sm border border-gray-200 rounded-[25px] px-3 py-2"><CalendarIcon size={20} /> <span>Last 7 days</span></div>
        </div>
      ...
      <div className="w-[580px] flex flex-col gap-6 border border-gray-200 rounded-lg px-8 py-8 ">
          ...
          <div className="flex flex-row gap-2 justify-between  ">
              <Card className="p-4 w-[160px]">
                ...
                <AlarmCheck size={42} className="bg-gray-200 rounded-full p-2" />
